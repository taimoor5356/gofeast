            ...
            <div class="container py-10 ">
                <div class="row gx-lg-0 gx-xl-8 gy-10 gy-md-10 gy-lg-0 mb-10  align-items-center">
                    ...
                    <div class="col-md-6 col-lg-6 mb-5 text-center text-lg-start" data-cues="slideInDown" data-group="page-title"
                        ...
                        <p>
                            <!--<span class="text-center">-->
                            After successful operations in the USA, we're now expanding to Pakistan and taking our technology-driven food delivery services worldwide. 
                            <br>
                            <br>
                            GoFeast uniquely combines food delivery with blockchain technology, making us the first blockchain-powered company in the food sector.
                            <!--</span>-->
                            </p>
                    </div>
                    <!--/column -->
