                                ...
                                <div id="accordion-1" class="accordion-wrapper">
                                        ...
                                        <div id="accordion-collapse-1-1" class="collapse"
                                            ...
                                            <div class="card-body">
                                                <p>GoFeast is a marketplace leveraging blockchain technology,
                                                    connecting
                                                    consumers with local restaurants and grocery stores.
                                                </p>
                                            </div>
                                            <!-- /.card-body -->
                                        </div>
                                        ...
                                        <div id="accordion-collapse-1-6" class="collapse"
                                            ...
                                            <div class="card-body">
                                                <p>There is no minimum amount for store pickup in place.
                                                    However, the
                                                    minimum order value for home delivery ranges from Rs200-250
                                                    depending
                                                    on the store
                                                </p>
                                            </div>
                                    ...
                                    <div class="card accordion-item">
                                        ...
                                        <div id="accordion-collapse-1-9" class="collapse"
                                            ...
                                            data-bs-target="#accordion-1">
                                            <div class="card-body">
                                                <p>GoFeast is currently available in USA and Southeast Asia for
                                                    ordering and
                                                    food delivery.
                                                </p>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <ul>
                                                    <li>You can email us at <a
                                                            href="mailto:cs@gofeast.pk">cs@gofeast.pk</a>
                                                    </li>
                                                    <li>Call us on <a href="tel:+923377777761">+92 337-7777-761</a>
                                                    </li>
                                                ...
                                                <ul>
                                                    <li>
                                                        You can email us at <a
                                                            href="mailto:cs@gofeast.pk">cs@gofeast.pk
                                                        </a>
                                                    </li>
                                                    <li>
                                                        Call us on <a href="tel:+923377777761">+92 337-7777-761</a>
                                                    </li>
                                                ...
                                                <div id="accordion-collapse-4-1" class="collapse"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                Call us on <a href="tel:923377777761">+923377777761</a>
                                                            </li>
                                                            <li>Send us an in-app chat</li>
                                                        </ul>
                                                    </div>
                                ...
                                <div id="accordion-5" class="accordion-wrapper">
                                        ...
                                        <div id="accordion-collapse-5-1" class="collapse"
                                            ...
                                            <div class="card-body">
                                                <p>Check your SPAM messages to see if the email hasn't
                                                    ...
                                                    reach
                                                    out to us on <a href="tel:923377777761 ">+92 337-7777-761</a></p>
                                            </div>
                                            <!-- /.card-body -->
                                        </div>
                                        <!-- /.collapse -->
                                            ...
                                            <div class="card-body">
                                                <p>You can check the status of your order real time using the
                                                    ...
                                                    Meat Customer Care Specialist on <a
                                                        href="tel:923377777761 ">+92 337-7777-761</a>
                                                </p>
                                            </div>
                                            <!-- /.card-body -->
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <p>Although we strive to have same day delivery, the delivery
                                                    ...
                                                    Customer Care Specialist on <a
                                                        href="tel:923377777761 ">+92 337-7777-761</a></p>
                                            </div>
                                            <!-- /.card-body -->
                                        </div>
                                        <!-- /.collapse -->
                                    ...
                                    <div class="card accordion-item">
                                        ...
                                        <div id="accordion-collapse-5-7" class="collapse"
                                            ...
                                            data-bs-target="#accordion-5">
                                            <div class="card-body">
                                                <p>Call customer support to get your order cancelled <a
                                                        href="tel:923377777761 ">+92 337-7777-761</a></p>
                                            </div>
                                            <!-- /.card-body -->
                                        </div>
